                ...
                <form method="post" action="<?php echo URLROOT; ?>/users/signup" class="forms" enctype="multipart/form-data">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <input class="form-control" type="text" id="password" name="email" required>
                            <label for="password1" style="padding-bottom: 1em">Подтвердите пароль: </label>
                            <input class="form-control <?php echo (!empty($data['pw_dont_match'])) ? is-invalid : '' ?>" type="text" id="password1" name="email" required>
